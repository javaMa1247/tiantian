...
public class JWTUtils {
    ...
    public static void main(String[] args) {
        ...
        // getTokenInfo("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwd2QiOiIxIiwiZXhwIjoxNjgyOTk2MzIwLCJ1c2VybmFtZSI6ImEifQ.D_2_25a7hricFjlsX-Kpv42AhYWjoL9rNDd6lrPkfIU");
        // System.out.println();
    ...
    public static String creatToken(Map<String, String> payload, int expireTime) {
        ...
        return builder.withExpiresAt(instance.getTime()).withClaim("purview", User).sign(Algorithm.HMAC256(SING));
    }
    ...
    public static String creatToken(Map<String, String> payload, int expireTime, String purview) {
        ...
        return builder.withExpiresAt(instance.getTime()).withClaim("purview", purview).sign(Algorithm.HMAC256(SING));
    }
