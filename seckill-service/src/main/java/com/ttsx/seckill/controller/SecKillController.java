...
public class SecKillController {
    ...
    public Map<String, Object> secKill(@RequestParam("time") String time, @RequestParam("seckillId") String fno,
        @RequestHeader(required = false) String uid, HttpServletRequest request) {
