...
create
database fresh default character set utf8 collate utf8_bin;
...
INSERT INTO goodsinfo
VALUES ('11', '农家土鸡蛋', '4', '66.00', '纯天然，无污染，生态喂养', '100', 'images/goods/goods401.jpg', '盒', '30天', '30个', null);
INSERT INTO goodsinfo
VALUES ('12', '天然鹌鹑蛋', '4', '5.00', '生态喂养，天然污染', '100', 'images/goods/goods402.jpg', '斤', '30天', '500G', null);
INSERT INTO goodsinfo
VALUES ('13', '有机芹菜', '5', '8.00', '生态种植，天然无污染', '100', 'images/goods/goods501.jpg;images/goods/goods502.jpg', '斤',
        '10天', '500G', null);
INSERT INTO goodsinfo
VALUES ('14', '有机莴笋', '5', '6.00', '纯天然，无污染，生态种植', '100', 'images/goods/goods503.jpg', '斤', '10天', '500G', null);
INSERT INTO goodsinfo
VALUES ('15', '水饺', '6', '30.00', '蔬菜水饺，美味健康', '100', 'images/goods/goods601.jpg;images/goods/goods602.jpg', '包', '20天',
        '2.5KG', null);
INSERT INTO goodsinfo
...
VALUES ('1', 'navy', '', 'c8837b23ff8aaa8a2dde915473ce0991', '15096098010', '475651857@qq.com', '',
        '2019-10-03 15:56:13', '1');
INSERT INTO memberinfo
VALUES ('2', 'yc', '', 'c8837b23ff8aaa8a2dde915473ce0991', '15096098012', '1293580602@qq.com', '',
...
-- 密码为MD5加密后的数据
insert into tbl_admin(aname, apwd)
values ('lxx', '0cc175b9c0f1b6a831c399e269772661');

insert into addrinfo(ano, mno, name, tel, province, city, area, addr, flag, status)
values (1, 1, 1, 1, 1, 1, 1, '湖南工学院', 1, 1);

insert into orderinfo(ono, odate, sdate, ano, status, price, invoice)
values (1, now(), now(), 1, 1, 118.3, 1);

insert into orderinfo(ono, odate, sdate, ano, status, price, invoice)
values (2, now(), now(), 1, 1, 114.2, 0);

insert into orderiteminfo(ono, gno, nums, price, status)
values (1, 1, 3, 48.2, 1);
...
insert into orderiteminfo(ono, gno, nums, price, status)
values (2, 3, 2, 128.5, 1);

insert into orderiteminfo(ono, gno, nums, price, status)
values (2, 8, 4, 422.1, 1);
...
-- 秒杀商品表
CREATE TABLE `FlashKilling`
(
    `fno`        int(11) NOT NULL AUTO_INCREMENT,
    `gno`        int(11) DEFAULT NULL,
    `fk_price`   decimal(8, 2) DEFAULT NULL,
    `count`      int(11) DEFAULT NULL,
    `start_data` DATE,
    `time`       int(11) DEFAULT NULL,
    PRIMARY KEY (`fno`),
    KEY          `FlashKilling_gno` (`gno`),
    CONSTRAINT `FlashKilling_gno` FOREIGN KEY (`gno`) REFERENCES `goodsinfo` (`gno`)
