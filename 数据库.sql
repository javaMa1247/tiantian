...
INSERT INTO cartinfo VALUES ('13', '1', '1', '4');
INSERT INTO cartinfo VALUES ('14', '1', '4', '3');
INSERT INTO cartinfo VALUES ('15', '1', '6', '2');
...
-- 密码为MD5加密后的数据
insert into tbl_admin(aname,apwd) values('lxx','0cc175b9c0f1b6a831c399e269772661');

insert into addrinfo(ano,mno,name,tel,province,city,area,addr,flag,status) values(1,1,1,1,1,1,1,'湖南工学院',1,1);

insert into orderinfo(ono,odate,sdate,ano,status,price,invoice) values(1,now(),now(),1,1,118.3,1);

insert into orderinfo(ono,odate,sdate,ano,status,price,invoice) values(2,now(),now(),1,1,114.2,0);

insert into orderiteminfo(ono,gno,nums,price,status) values(1,1,3,48.2,1);

insert into orderiteminfo(ono,gno,nums,price,status) values(1,4,6,42.8,1);

insert into orderiteminfo(ono,gno,nums,price,status) values(2,3,2,128.5,1);

insert into orderiteminfo(ono,gno,nums,price,status) values(2,8,4,422.1,1);
