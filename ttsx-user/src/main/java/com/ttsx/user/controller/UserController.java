...
public class UserController {
    ...
    public Map<String, Object> login(Memberinfo memberinfo, HttpServletResponse response, HttpSession session) {
        LambdaQueryWrapper<Memberinfo> qw = new LambdaQueryWrapper<>();
        qw.eq(Memberinfo::getNickName, memberinfo.getNickName()).eq(Memberinfo::getPwd,
            (Md5.MD5Encode(memberinfo.getPwd(), "utf-8")));
    ...
    public Map<String, java.io.Serializable>
        selectUserInfo(@RequestHeader(value = "Authorization", required = false) String token) {
    ...
    public Map<String, Object> checkLogin(@RequestHeader String token) {
    ...
    public Map<String, java.io.Serializable> logon(@RequestParam("nickName") String nickName,
        @RequestParam("pwd") String pwd, @RequestParam("pwd1") String pwd1, @RequestParam("email") String email) {
        Map<String, java.io.Serializable> map = new HashMap<>();
        Map<String, Map<String, java.io.Serializable>> map1 = new HashMap<String, Map<String, java.io.Serializable>>();
    ...
    public Map<String, java.io.Serializable> deliverPort(@RequestParam("nickName") String nickName,
        ...
        try {
            LambdaQueryWrapper<Memberinfo> qw = new LambdaQueryWrapper<>();
            qw.eq(Memberinfo::getNickName, nickName).eq(Memberinfo::getEmail, email);
            Memberinfo one = userServlet.getOne(qw);
            if (one == null) {
                map.put("code", 0);
    ...
    public Map<String, java.io.Serializable> updatePass(@RequestParam("port") String yzport,
        @RequestParam("email") String email, @RequestParam("pwd") String pwd, @RequestParam("pwd1") String pwd1,
        ...
        try {
            if (yzport == null || "".equals(yzport)) {
                ...
                String pwd2 = (Md5.MD5Encode(pwd, "utf-8"));
                updateWrapper.set("pwd", pwd2).eq("nickName", nickName);
    ...
    public Map<String, Object> showName(HttpServletRequest request, HttpServletResponse response) {
    ...
    public Map<String, Integer> checkUname(@RequestParam("nickName") String nickName) {
